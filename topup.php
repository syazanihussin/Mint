...
<head>
  <meta charset="UTF-8">
  <title>Topup | Delivery Person</title>
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600" rel="stylesheet">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
  <link rel="stylesheet" href="css/payment style 2.css">
    ...
    $(document).ready(function(){
      $("#money").click(function(){
        ...
        $.ajax({
          ...
          dataType:"json",
          type: "POST",
          data: {table : 'delivery_person', updating : 'topup = '+ amount +'', where : 'username = "<?php echo $_GET['username']; ?>"', message : 'topup'},
...
<body>
  ...
  <div class="modal">
    <div class="modal__container">
      ...
      <div class="modal__content">
        ...
        <ul style="padding= 4em;" class="form-list">
            <li class="form-list__row">
              <label>Amount to Topup</label>
              <input id="amount" type="number" name="" required="" />
            </li>
            <li class="form-list__row">
              <label>Name</label>
            ...
            <li>
              <button id="money" type="submit" class="button">Topup Now</button>
            </li>
          </ul>
  ...
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js'></script>
    ...
    <script  src="js/payment js.js"></script>
